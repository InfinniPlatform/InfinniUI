    ...
    describe( 'TreeModel', function() {
        ...
        it( 'Handling deep sets', function() {
            ...
            treeModel.onPropertyChanged( 'p1.p11', function( context, args ) {
                ...
                assert.isTrue( typeof args.oldValue === 'undefined' || args.oldValue === null || args.oldValue == 1, 'old value is right' );
        ...
        it( 'Auto unsubscribing if owner is checked as removed', function() {
            ...
            treeModel.onPropertyChanged( 'p1.p11', function( context, args ) {
                ...
                assert.isTrue( typeof args.oldValue === 'undefined' || args.oldValue === null || args.oldValue == 1 || args.oldValue == 2, 'old value is right' );
