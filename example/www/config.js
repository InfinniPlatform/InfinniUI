...
window.InfinniUI.config.homePage = 'testConfigurations/datagrid.json'; //{ConfigId: InfinniUI.config.configId, DocumentId: 'Common', MetadataName: 'HomePage'}; //'stab.json'
