...
window.InfinniUI.config.homePage = 'testConfigurations/tablepanel.json'; //{ConfigId: InfinniUI.config.configId, DocumentId: 'Common', MetadataName: 'HomePage'}; //'stab.json'
