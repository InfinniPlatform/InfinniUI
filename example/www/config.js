...
window.InfinniUI.config.homePage = 'testConfigurations/combobox.json'; //{ConfigId: InfinniUI.config.configId, DocumentId: 'Common', MetadataName: 'HomePage'}; //'stab.json'
