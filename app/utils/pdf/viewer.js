...
PDFJS.imageResourcesPath = '/app/utils/pdf/images/';
  PDFJS.workerSrc = '/app/utils/pdf/build/pdf.worker.js';
  PDFJS.cMapUrl = '/app/utils/pdf/web/cmaps/';
...
function webViewerInitialized() {
  ...
  var docId = location.hash.substr(1);
  //if (file) {
    PDFViewerApplication.open(window.parent.pdfDocs[docId], 0);
  //}
}
